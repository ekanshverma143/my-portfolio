          ...
          <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
            <Col md={4} className="project-card">
              <ProjectCard
                ...
                isBlog={false}
                title="Edu-BOT (An AI/ML project)"
                description="The platform under development is a comprehensive learning and knowledge-sharing tool intended to facilitate the acquisition and retention of information. It provides various learning-enhancing features, such as Book Buddy, YouTube Plus, and Learn It.   
                    TechStack-Html,CSS,JS,Python,Django,GTTS,NTLK]"
                ghLink="https://github.com/swastkk/edubot"
              />
            </Col>
